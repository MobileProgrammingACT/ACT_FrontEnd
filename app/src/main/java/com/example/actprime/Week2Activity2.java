...
public class Week2Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week2_activity2);

        DatabaseReference myref = db.getReference("/Act/Week2/day2");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Week2Activity2.this, "저장했습니다", Toast.LENGTH_SHORT).show();
                ((Week2) Week2.mContext).week2ActivityBtn3.setEnabled(true);
                ((Week2) Week2.mContext).week2ActivityBtn2.setBackgroundColor(Color.argb(100, 255, 153, 153));
    ...
    public void writereview(String content) {
        ...
        ref.child("Act").child("Week2").child("day2").setValue(content);
    }
