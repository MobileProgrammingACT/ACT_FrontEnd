...
public class Week1Activity7 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week1_activity7);

        DatabaseReference myref = db.getReference("/Act/Week1/day7");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MainActivity) MainActivity.maContext).weekSelectBtn1.setBackground(getResources().getDrawable(R.drawable.round_change_button));
    ...
    public void writereview(String content) {
        ...
        ref.child("Act").child("Week1").child("day7").setValue(content);
    }
