...
public class Week3Activity7 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week3_activity7);

        DatabaseReference myref = db.getReference("/Act/Week3/day7");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((MainActivity) MainActivity.maContext).weekSelectBtn3.setBackgroundColor(Color.argb(100, 230, 230, 250));
            }
        });
    ...
    public void writereview(String content) {
        ...
        ref.child("Act").child("Week3").child("day7").setValue(content);
    }
