...
public class Week2Activity6 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week2_activity6);

        DatabaseReference myref = db.getReference("/Act/Week2/day6");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Week2Activity6.this, "저장했습니다", Toast.LENGTH_SHORT).show();
                ((Week2) Week2.mContext).week2ActivityBtn7.setEnabled(true);
                ((Week2) Week2.mContext).week2ActivityBtn6.setBackgroundColor(Color.argb(100, 255, 153, 153));
    ...
    public void writereview(String content) {
        ...
        ref.child("Act").child("Week2").child("day6").setValue(content);
    }
