...
public class Week3Activity6 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week3_activity6);

        DatabaseReference myref = db.getReference("/Act/Week3/day6");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Week3Activity6.this, "저장했습니다", Toast.LENGTH_SHORT).show();
                ((Week3) Week3.mContext).week3ActivityBtn7.setEnabled(true);
                ((Week3) Week3.mContext).week3ActivityBtn6.setBackgroundColor(Color.argb(100, 255, 153, 153));
    ...
    public void writereview(String content) {
        ...
        ref.child("Act").child("Week3").child("day6").setValue(content);
    }
