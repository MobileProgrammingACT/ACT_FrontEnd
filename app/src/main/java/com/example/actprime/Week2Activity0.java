...
public class Week2Activity0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week2_activity0);

        seekBar = (SeekBar) findViewById(R.id.seekBar);
        explanation = (Button) findViewById(R.id.explanation);

        source = new MediaPlayer();
        source = MediaPlayer.create(Week2Activity0.this, R.raw.week2_activity0_explanation);
