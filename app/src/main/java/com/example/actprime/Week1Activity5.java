...
public class Week1Activity5 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week1_activity5);

        DatabaseReference myref = db.getReference("/Act/Week1/day5");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Week1Activity5.this, "저장했습니다", Toast.LENGTH_SHORT).show();
                ((Week1) Week1.mContext).week1ActivityBtn6.setEnabled(true);
                ((Week1) Week1.mContext).week1ActivityBtn5.setBackgroundColor(Color.argb(100, 255, 153, 153));
