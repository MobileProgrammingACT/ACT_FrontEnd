...
public class Week3Activity0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week3_activity0);

        seekBar = (SeekBar) findViewById(R.id.seekBar);
        explanation = (Button) findViewById(R.id.explanation);

        source = new MediaPlayer();
        source = MediaPlayer.create(Week3Activity0.this, R.raw.week3_activity0_explanation);
